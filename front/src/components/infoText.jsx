...
function InfoText(props) {
    ...
    const info = {
        ...
        carbInfo: 'Para deportistas de resistencia, se sugieren entre 6 y 10 gramos por kilogramo de peso corporal al día, mientras que para deportes de fuerza, la recomendación es entre 4 y 7 gramos por kilogramo de peso corporal al día.</br> ',
